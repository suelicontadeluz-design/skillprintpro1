-- ROLLBACK de fn_score_lead_campanha para a versao vigente ate 25/08/2026.
-- Baseline: md5(prosrc)=d9c3f6ae4348a09eb6896152e81d3225, 1804 chars.
-- ATENCAO: esta versao contem os dois bugs comprovados (status='open' que nunca
-- dispara, e inserido_em que confunde data de sync com data da proposta).
-- Restaurar apenas se o patch causar efeito nao previsto.
...
BEGIN
  ...
  SELECT EXISTS(
    ...
    WHERE lead_id = p_lead_id
      AND inserido_em >= NOW() - INTERVAL '30 days'
