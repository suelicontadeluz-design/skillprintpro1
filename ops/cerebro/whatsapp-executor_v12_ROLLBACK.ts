// ROLLBACK R12 — whatsapp-executor v12 (versao 82, ezbr_sha256
// af715998486b81e456f266e561a5fe1526d1a64e34e0df04e19cadb9c8f5025b).
// Redeploy deste arquivo desfaz o v13. Rodar ANTES do rollback SQL.
//
// whatsapp-executor v12
...
function log(step: string, status: string, detail: any = {}) {
  console.log(JSON.stringify({ step, status, v: 'v12', ...detail }));
}
...
Deno.serve(async (_req) => {
  ...
  const { data: lr } = await sb.rpc('fn_cron_log_start', { p_job: 'whatsapp-executor', p_meta: { lote: fila.length, canal: 'botconversa_api', versao: 'v12' } });
