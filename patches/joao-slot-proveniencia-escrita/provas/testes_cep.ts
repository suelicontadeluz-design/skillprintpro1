...
const B434 = fs.readFileSync(new URL('../base435.ts', import.meta.url), 'utf8');
...
// ── INVARIANTES v4.34.0 INTACTAS ───────────────────────────────────────
{
  ...
  // Marcador de versao: o que esta suite garante e que a v4.35.0 nao regrediu, nao que o
  // numero congelou. Confere a versao vigente do candidato.
  check('E4 versao logica avancou sem perder a v4.35.0',
    /const V = 'agente-noturno-v4\.(3[6-9]|[4-9]\d)/.test(CAND), '');
