...
function buscarCaminho(raiz, caminho) {
  let atual = raiz;
...
export function extrairProviderId(corpo) {
  const vazio = { id: null, origem: null, chaves: [], forma: 'vazio' };
  ...
  const alvo = ehArray ? parsed[0] : parsed;
  const chaves =
    alvo !== null && typeof alvo === 'object' && !Array.isArray(alvo)
      ? Object.keys(alvo).slice(0, 20)
      : [];
