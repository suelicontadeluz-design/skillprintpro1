...
// João Skill Orchestrator v1.3 — 09/09/2026
// v1.3 preserva o v1.2 e fecha um erro real observado em produção:
// respostas de espera/continuação do cliente ("já te passo", "vou conferir", "vou terminar as artes")
// não podem reabrir sondagem, trocar de assunto ou disparar ação comercial.
...
const JO_VERSION = 'joao-skill-orchestrator/v1.3';
