...
// João Product/Service Disambiguation v2 — 10/09/2026
// Previsibilidade P4: só esclarece quando há contexto DTF + peça física + modalidade realmente ambígua.
// Corrige falsos positivos reais: "copo long drink personalizado" e "se fosse já no copo?".
// Mantém o caso original "de caneca e camisa" como ambíguo.
...
const PD_VERSION = 'joao-product-service-disambiguation/v2';
let pdCfgAt = 0;
let pdCfg = false;
