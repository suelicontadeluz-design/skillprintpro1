...
const V="order-email-brevo-dispatcher/v2";
...
function render(event:any){
  ...
  const html=`<!doctype html><html><body style="margin:0;padding:0;background:#f4f4f5;font-family:Arial,Helvetica,sans-serif;color:#18181b"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f4f4f5"><tr><td align="center" style="padding:32px 14px"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px"><tr><td style="padding:0 2px 12px;font-size:12px;color:#71717a">Atualização do seu pedido</td></tr><tr><td style="background:#ffffff;border:1px solid #e4e4e7;border-radius:16px;overflow:hidden"><table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td style="background:#111827;padding:22px 26px"><div style="font-size:22px;font-weight:800;color:#ffffff;letter-spacing:.4px">SKILLPRINT</div><div style="font-size:12px;color:#d4d4d8;margin-top:4px">Estamparia & Personalizados</div></td></tr><tr><td style="padding:28px 26px 8px"><div style="display:inline-block;background:#fff7ed;color:#c2410c;font-size:12px;font-weight:700;padding:6px 10px;border-radius:999px">Pedido #${esc(numero)}</div><h1 style="font-size:26px;line-height:1.2;margin:16px 0 12px;color:#18181b">${title}</h1><div style="font-size:16px;line-height:1.65;color:#3f3f46">${body}</div>${action}</td></tr><tr><td style="padding:18px 26px;background:#fafafa;border-top:1px solid #e4e4e7;font-size:12px;line-height:1.55;color:#71717a">Esta é uma atualização automática do seu pedido na Skillprint Estamparia.<br>Se precisar falar com a equipe, responda este e-mail.</td></tr></table></td></tr><tr><td style="padding:14px 4px 0;text-align:center;font-size:11px;color:#a1a1aa">Skillprint Estamparia · Pedido #${esc(numero)}</td></tr></table></td></tr></table></body></html>`;
