// Candidate A+B v4 replay wrapper — replay only.
...
if (importError || !harnessHandler) {
  ...
  realServe(async (req: Request) => {
    ...
    if (body && typeof body === 'object') {
      body.harness = 'joao-replay-candidato-ab-20260913/harness-v3-candidate-ab-v4';
      body.composicao_sha256 = 'candidate-ab-v4-late-acquisition-reference'; body.candidate_sha = 'candidate-ab-v4-late-acquisition-reference';
