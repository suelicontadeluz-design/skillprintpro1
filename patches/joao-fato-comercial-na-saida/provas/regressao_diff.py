# -*- coding: utf-8 -*-
"""Prova de nao-regressao por DIFF, nao por declaracao — frente v4.38.0 (fase 2).
...
ALTERADOS_DELIBERADAMENTE = [
    # A FASE 2 altera de proposito UM unico segmento: a versao.
    # Todo o resto e insercao pura (modulo da guarda + bloco no transporte).
